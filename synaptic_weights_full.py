...
def lognorm_analysis_figure(idx):
    ...
    synapse_weight_distribution_loglog_t(axs['1,3'], tr, crun, tstep=-1, bins=50)

    synapse_weight_distribution_t(axs['2,1'], tr, crun, tstep=-1, bins=50,
                                  low_bound=0.00001*tr.ATotalMax)
    synapse_weight_distribution_log_t(axs['2,2'], tr, crun, tstep=-1, bins=50,
                                      low_bound=0.00001*tr.ATotalMax)
    synapse_weight_distribution_loglog_t(axs['2,3'], tr, crun, tstep=-1,
                                         bins=50, low_bound=0.00001*tr.ATotalMax)
    ...
    synapse_weight_distribution_t(axs['3,1'], tr, crun, tstep=-1, bins=50,
                                  low_bound=0.0001*tr.ATotalMax)
    synapse_weight_distribution_log_t(axs['3,2'], tr, crun, tstep=-1, bins=50,
                                      low_bound=0.0001*tr.ATotalMax)
    synapse_weight_distribution_loglog_t(axs['3,3'], tr, crun, tstep=-1,
                                         bins=50, low_bound=0.0001*tr.ATotalMax)


    synapse_weight_distribution_t(axs['4,1'], tr, crun, tstep=-1, bins=50,
                                  low_bound=0.001*tr.ATotalMax)
    synapse_weight_distribution_log_t(axs['4,2'], tr, crun, tstep=-1, bins=50,
                                      low_bound=0.001*tr.ATotalMax)
    synapse_weight_distribution_loglog_t(axs['4,3'], tr, crun, tstep=-1,
                                         bins=50, low_bound=0.001*tr.ATotalMax)

    synapse_weight_distribution_t(axs['5,1'], tr, crun, tstep=-1, bins=50,
                                  low_bound=0.01*tr.ATotalMax)
    synapse_weight_distribution_log_t(axs['5,2'], tr, crun, tstep=-1, bins=50,
                                      low_bound=0.01*tr.ATotalMax)
    synapse_weight_distribution_loglog_t(axs['5,3'], tr, crun, tstep=-1,
                                         bins=50, low_bound=0.01*tr.ATotalMax)


    synapse_weight_distribution_t(axs['6,1'], tr, crun, tstep=-1, bins=50,
                                  low_bound=0.05*tr.ATotalMax)
    synapse_weight_distribution_log_t(axs['6,2'], tr, crun, tstep=-1, bins=50,
                                      low_bound=0.05*tr.ATotalMax)
    synapse_weight_distribution_loglog_t(axs['6,3'], tr, crun, tstep=-1,
                                         bins=50, low_bound=0.05*tr.ATotalMax)
